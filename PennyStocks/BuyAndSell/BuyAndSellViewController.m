...
- (void)viewDidLoad {
    ...
    self.buyAssetPriceField.doubleValue = [calculator ethPriceForAsset:self.tabLabel];
    self.sellAssetPriceField.doubleValue = [calculator ethPriceForAsset:self.tabLabel];
