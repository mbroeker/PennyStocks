...
- (void)initializeWithDefaults {
    ...
    if (traders == nil) {
        traders = [@{
            TV_HOMEPAGE: @"https://www.4customers.de/pennystocks/",
 ...
 */
- (void)pennyStocksOnExchange {
    NSDebug(@"TemplateViewController::pennyStocksOnExchange");
...
- (void)updateOverview {
    ...
    if (loop_vars.initialBalancesInEUR != 0) { loop_vars.coinchange.effectivePercent = 100.0 * ((loop_vars.totalBalancesInEUR / loop_vars.initialBalancesInEUR) - 1); }
